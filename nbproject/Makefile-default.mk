...
${OBJECTDIR}/Interrupt.o: Interrupt.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Interrupt.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_ICD3=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Interrupt.lst\" -e\"${OBJECTDIR}/Interrupt.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/Interrupt.o\" \"Interrupt.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/Interrupt.o"
	@${FIXDEPS} "${OBJECTDIR}/Interrupt.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
	
${OBJECTDIR}/ADC_read.o: ADC_read.asm  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ADC_read.o.d 
	@${RM} ${OBJECTDIR}/ADC_read.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/ADC_read.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_ICD3=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/ADC_read.lst\" -e\"${OBJECTDIR}/ADC_read.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/ADC_read.o\" \"ADC_read.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/ADC_read.o"
	@${FIXDEPS} "${OBJECTDIR}/ADC_read.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
...
${OBJECTDIR}/Hex_to_Decimal.o: Hex_to_Decimal.asm  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Hex_to_Decimal.o.d 
	@${RM} ${OBJECTDIR}/Hex_to_Decimal.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Hex_to_Decimal.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_ICD3=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Hex_to_Decimal.lst\" -e\"${OBJECTDIR}/Hex_to_Decimal.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/Hex_to_Decimal.o\" \"Hex_to_Decimal.asm\" 
...
${OBJECTDIR}/ADC_read.o: ADC_read.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/ADC_read.o.d 
	@${RM} ${OBJECTDIR}/ADC_read.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/ADC_read.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/ADC_read.lst\" -e\"${OBJECTDIR}/ADC_read.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/ADC_read.o\" \"ADC_read.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/ADC_read.o"
	@${FIXDEPS} "${OBJECTDIR}/ADC_read.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
...
${OBJECTDIR}/Hex_to_Decimal.o: Hex_to_Decimal.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Hex_to_Decimal.o.d 
	@${RM} ${OBJECTDIR}/Hex_to_Decimal.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/Hex_to_Decimal.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/Hex_to_Decimal.lst\" -e\"${OBJECTDIR}/Hex_to_Decimal.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/Hex_to_Decimal.o\" \"Hex_to_Decimal.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/Hex_to_Decimal.o"
	@${FIXDEPS} "${OBJECTDIR}/Hex_to_Decimal.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
